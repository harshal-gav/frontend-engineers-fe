      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="leading-relaxed">Some parts of the service are billed on a subscription basis to unlock full access. You will be billed in advance on a recurring and periodic basis. Payment processing is handled securely by Razorpay, our payment gateway partner.</p>
          </section>
