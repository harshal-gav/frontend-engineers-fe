      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="leading-relaxed">We collect information you provide directly to us when you create an account, subscribe to our premium service, or otherwise communicate with us. This includes your email address, name, and payment information processed by our secure payment provider (Gumroad).</p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">We use trusted third-party services such as Google Firebase for authentication and database management, and Gumroad for payment processing. These services have their own stringent privacy policies regarding the data they collect and process.</p>
          </section>
