...
export default function PricingModal({
  ...
  const gumroadUrl = process.env.NEXT_PUBLIC_GUMROAD_PRODUCT_ID
    ? `https://gumroad.com/l/${process.env.NEXT_PUBLIC_GUMROAD_PRODUCT_ID}`
    : "https://gumroad.com";
        ...
        <div className="relative w-full max-w-md max-h-[90vh] overflow-y-auto glass-card p-6 sm:p-8 rounded-2xl animate-fade-in-up">
          ...
          <div className="flex flex-col gap-3 mt-8">
            {!user ? (
              ...
              <a
                href={`${gumroadUrl}?email=${encodeURIComponent(user.email || "")}`}
                className="w-full btn-primary py-3.5 rounded-xl text-black bg-[#00ffcc] font-bold text-base inline-block text-center"
              >
